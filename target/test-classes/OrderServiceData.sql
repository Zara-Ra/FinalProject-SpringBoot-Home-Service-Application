insert into credit (id, amount)
values (5,100);

insert into customer (id, email, password,enabled, first_name, last_name, credit_id)
values (5, 'order_service_test@email.com', 'customer',true, 'Name', 'Lastname', 5);
