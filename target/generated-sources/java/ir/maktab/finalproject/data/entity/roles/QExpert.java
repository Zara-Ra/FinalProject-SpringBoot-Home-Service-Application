...
public class QExpert extends EntityPathBase<Expert> {
    ...
    public final ListPath<ir.maktab.finalproject.data.entity.SubService, ir.maktab.finalproject.data.entity.QSubService> subServiceList = this.<ir.maktab.finalproject.data.entity.SubService, ir.maktab.finalproject.data.entity.QSubService>createList("subServiceList", ir.maktab.finalproject.data.entity.SubService.class, ir.maktab.finalproject.data.entity.QSubService.class, PathInits.DIRECT2);
